# Загрезка нового набоа стикеров
...
Пользователь может выбрать стикер из конкретного набора [выбрать стикер из конкретного набора](https://github.com/polinanov/use-case-and-diagram/blob/master/send_stickers.md "Выбрать стикер из конкретного набора").
...
Пользователь может выбрать загрузить набор существующих стикеров [загрузить набор существующих стикеров](#Загрузить_набор_существующих_стикеров).  
