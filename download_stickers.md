...
Пользователь может выбрать стикер из конкретного набора [выбрать_стикер_из_конкретного набора](https://github.com/polinanov/use-case-and-diagram/blob/master/send_stickers.md "Выбрать стикер из конкретного набора").
